        ...
        <div className="flex h-screen flex-col lg:grid lg:grid-cols-10">
            ...
            <div className="lg:col-span-4 bg-gradient-to-br from-cyan-800 to-rose-500">
                <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
                    <div className="rounded-xl bg-gradient-to-br from-yellow-400 to-purple-600">
                        <img className="w-44 rounded-xl object-cover lg:h-96 lg:w-72" src="https://links.papareact.com/8sg" alt=""></img>
            ...
            <div className="flex flex-1 flex-col p-12 lg:col-span-6">
                ...
                <div className="mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:space-y-0">
                    ...
                    <h1 className="text-3xl font-bold lg:text-5xl lg:font-extrabold">The Aditya Coding Club</h1>
                    <p className="pt-2 text-xl text-green-500">13/21 NFTs claimed</p>
                </div>

                {/* Mint Button */}
                <button className="h-16 w-full bg-red-600 text-white rounded-full font-bold">Mint NFT(0.01 ETH)</button>
